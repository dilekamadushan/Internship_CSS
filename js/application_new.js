...
Application.prototype.getMainMenu = function() {
    ...
    var new_items = [
		{"level":"1","name":"Dashboard", "url":"dashboard1", "permission_list":"rbt_access_profile_create,rbt_access_profile_view","image":"fa fa-dashboard","sub_menu":false},
		{"level":"1","name":"Charging Scheme", "url":"charging_scheme", "permission_list":"rbt_charging_scheme_create,rbt_charging_scheme_view","image":"fa fa-bar-chart",
		"sub_menu":[{"name":"Create", "url":"charging_scheme", "permission_list":"rbt_charging_scheme_create","sub_menu":false},
					{"name":"Manage", "url":"charging_scheme_view", "permission_list":"rbt_charging_scheme_view","sub_menu":false}]},
		{"level":"1","name":"Service Access Profile", "url":"service_access_profile", "permission_list":"rbt_access_profile_create,rbt_access_profile_view","image":"fa fa-cogs",		
			"sub_menu":[{"level":"2","name":"Create", "url":"service_access_profile", "permission_list":"rbt_access_profile_create","sub_menu":false},
						{"level":"2","name":"Manage", "url":"service_access_profile_view", "permission_list":"rbt_access_profile_view",
						"sub_menu":[{"level":"3","name":"Create", "url":"service_access_profile", "permission_list":"rbt_access_profile_create"},
									{"level":"3","name":"Manage", "url":"dashboard", "permission_list":"rbt_access_profile_view"}]}]},					
	];
...
Application.prototype.getMainMenuSet = function(items, image) {
	...
	switch (page) {
		case "dashboard1":
			level1 = "dashboard";
			break;	
		case "charging_scheme":
			level1 = "charging_scheme";
			level2 = "charging_scheme";
			break;
		case "charging_scheme":
			level1 = "charging_scheme";
			level2 = "charging_scheme_view";
			break;	
		case "dashboard":
