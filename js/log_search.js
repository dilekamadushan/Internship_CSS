...
LogManager.prototype.escapeHtml = function(str) {
...
LogManager.prototype.formatString = function(str) {
...
LogManager.prototype.viewDesc = function(str) {
 
	jQuery('#view-pop1').html(unescape(str)); 
	$( "#view-pop1" ).dialog( "open" );
}

LogManager.prototype.replaceAll = function(find, str) {
...
LogManager.prototype.getLogLevel = function(currentValue) {
...
LogManager.prototype.getWebServices = function(currentValue) {
...
LogManager.prototype.getServerId = function(currentValue) {
...
LogManager.prototype.getEventType = function(currentValue) {
...
LogManager.prototype.getCdrEventType = function(currentValue) {
...
LogManager.prototype.getCallType = function(currentValue) {
...
LogManager.prototype.getCallCategory = function(currentValue) {
...
LogManager.prototype.getModule = function(currentValue) {
...
LogManager.prototype.getAdmins = function(currentValue) {
...
LogManager.prototype.exportDynamicContent = function() {
...
LogManager.prototype.WebLogSearch = function(state) {
...
LogManager.prototype.WebLogCsv = function() {
	var log_type  =	$("#web_service").val();
	var from_date = $('#webFromDate').val();
	var to_date   = $('#webToDate').val();
	var from	= from_date ;
...
LogManager.prototype.ActivitySearch = function(state) {	
 ...
 * Export numbers to CSV.
 */
LogManager.prototype.ActivityCsv = function() {	
...
LogManager.prototype.CdrLogSearch = function(state) {	
 ...
 * Export numbers to CSV.
 */
LogManager.prototype.CdrLogCsv = function() {	
...
LogManager.prototype.resetDownloadedFrm = function(){
	multiDelStatus = 2;
	$( "#bulk_del_reset_area" ).hide();
	
}

LogManager.prototype.bulkDelete = function() {
...
LogManager.prototype.hideMultiDelColumn = function() {
...
LogManager.prototype.showMultiDelColumn = function() {
	var elemsTD = document.getElementsByClassName('delete_logs_columns');
	var elemsTH = document.getElementsByClassName('delete_all_logs_columns');
...
LogManager.prototype.formatDateTime = function(date, time) {
...
LogManager.prototype.grantAccess = function() {
